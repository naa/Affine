...
{\em Catalogue identifier:}  AENA\textunderscore v1\textunderscore 0                                 \\
...
The tensor product is also implemented but only for finite-dimensional Lie algebras, since the tensor product of affine Lie algebra modules leads to rich new structures \cite{kazhdan1994tensor3,kazhdan1993tensor1,kazhdan1993tensor2} which are out of the scope of the present paper.
\begin{lstlisting}[mathescape=true]
