...
$\includegraphics[width=130mm]{irrep-verma-pverma.pdf}$
\end{lstlisting}
...
$\includegraphics[width=60mm]{irrep-sum.pdf}$
\end{lstlisting}
...
$\includegraphics[width=60mm]{tensor-product.pdf}$
\end{lstlisting}
...
\begin{figure}[h]
  \noindent\centering{
   \includegraphics[width=100mm]{branching-timing.pdf}
  }
...
\begin{figure}[h]
  \noindent\centering{
    \includegraphics[width=80mm]{G2-irrep.pdf}
  }
...
\begin{figure}[h]
  \noindent\centering{
    \includegraphics[width=150mm]{G2-pverma.pdf}
  }
