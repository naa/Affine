...
Show[textPlot/@{im,vm,pm}]
\end{lstlisting}
\begin{figure}[h]
  \label{irrep-verma-pverma}
  \noindent\centering{
    \includegraphics[width=150mm]{irrep-verma-pverma.pdf}
  }
  \caption{Weight diagrams of $B_{2}$ highest weight modules with highest weight $[2,1]$: irreducible, Verma, parabolic Verma. Produced by code of Listing}
\end{figure}
...
Computation of weight multiplicities in function and branching coefficients 
